...
insert into user (id, name, email, phone) values (13, 'Smith Adam', 'adamS@bla.com', 234-456-678);
insert into user (id, name, email, phone) values (14, 'bob', 'bob@xyz.com', 048-564-957);
insert into user (id, name, email, phone) values (15, 'cristey M', 'cristeyM@example.com', 049-645-234);
insert into user (id, name, email, phone) values (16, 'john', 'john@sportify.com', 037-254-797);
...
insert into task (id, title, description, created, updated, due_date, status_id, user_id) values (36, 'DO homeworks', 'Title says it all, just do your homework', '2018-12-17 03:48:18', '2018-12-27 16:48:59','2019-01-20 15:05:39' , 2, 1);
